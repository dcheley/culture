...
User.create({ email: "admin@email.com", password: "123456", admin: 1, name: "Bob", organization: "We Test" })
...
Content.create([
  { name: "The Tour",
    ...
    admin_description: "Take the new hire on a tour of the organization. On this tour you must cover the content below.",
  ...
  { name: "Team Meeting",
    new_hire_description: "You’re going to spend a lot of time with your new team members
    ...
    admin_description: "You and the rest of the team facilitating a team meeting where you will cover the content below.",
  ...
  { name: "Stakeholder Exposure",
    ...
    admin_description: "meeting with the new hire of organization’s name and explaining to them the below content",
  ...
  { name: "Pre-first day Meet and Greet",
    ...
    admin_description: "Meeting with the new hire via phone, coffee, lunch, Skype or any other means you agree on before their first day of work and covering the content below.",
  ...
  { name: "One-on-one with Manager",
    ...
    admin_description: "Having a one-on-one with the new hire in order to start the manager/employee relationship off on the right foot and covering the content below.",
  ...
  { name: "Lunch with co-worker",
    ...
    admin_description: "Having lunch with the new hire in order to better get to know each other and covering the content below.",
  ...
  { name: "Job Shadowing",
    ...
    admin_description: "Allowing the new hire to shadow a job in order to gain a more holistic view of the organiztion. Make sure you cover the content below.",
  ...
  { name: "Superier's expectations",
    ...
    admin_description: "Sitting down and speaking to the new employee about the norms and practices of the organization and what you will expect of them by covering the content below.",
  ...
  { name: "Coffee with a co-worker",
    ...
    admin_description: "Take the new hire out for a cup of coffee in order to better get to know them and tell them more about the organization during the activity. Make sure to cover the content below.",
  ...
  { name: "Career Progression Discussion",
    ...
    admin_description: "Speaking to the new hire about how the typical career path plays out within the organization. Also discuss their goals and career aspirations. Make sure you cover the content below.",
